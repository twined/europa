  ...
  return function (css) {
    ...
    css.walkAtRules('column', atRule => {
      ...
      if (suppliedBreakpoint && (0, _advancedBreakpointQuery.default)(suppliedBreakpoint)) {
        throw atRule.error(`COLUMN: Column only accepts simple breakpoints, not advanced queries. This is due to gutter calculations`, {
          name: suppliedBreakpoint
        });
      }
...
function createFlexDecls(flexDecls, flexSize) {
  ...
  flexDecls.push((0, _buildDecl.default)('flex', `0 0 ${flexSize}`));
