...
var _default = _postcss.default.plugin('europacss-color', getConfig => {
  return function (css) {
    ...
    css.walkAtRules('color', atRule => {
      ...
      switch (target) {
        case 'fg':
          decl = (0, _buildDecl.default)('color', resolvedColor || color);
          break;

        case 'bg':
          decl = (0, _buildDecl.default)('background-color', resolvedColor || color);
          break;

        case 'fill':
          decl = (0, _buildDecl.default)('fill', resolvedColor || color);
          break;

        case 'stroke':
          decl = (0, _buildDecl.default)('stroke', resolvedColor || color);
          break;

        case 'border':
          decl = (0, _buildDecl.default)('border-color', resolvedColor || color);
          break;

        case 'border-top':
          decl = (0, _buildDecl.default)('border-top-color', resolvedColor || color);
          break;

        case 'border-bottom':
          decl = (0, _buildDecl.default)('border-bottom-color', resolvedColor || color);
          break;

        case 'border-left':
          decl = (0, _buildDecl.default)('border-left-color', resolvedColor || color);
          break;

        case 'border-right':
          decl = (0, _buildDecl.default)('border-right-color', resolvedColor || color);
          break;
