...
var _default = _postcss.default.plugin('europacss-column-typography', getConfig => {
  return function (css) {
    ...
    css.walkAtRules('column-typography', atRule => {
      ...
      const flexDecls = [(0, _buildDecl.default)('position', 'relative'), (0, _buildDecl.default)('flex-grow', '0'), (0, _buildDecl.default)('flex-shrink', '0'), (0, _buildDecl.default)('flex-basis', flexSize), (0, _buildDecl.default)('max-width', flexSize), (0, _buildDecl.default)('padding-right', paddingSize)];
