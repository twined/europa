  ...
  return function (css) {
    ...
    css.walkAtRules('europa', atRule => {
      if (atRule.params === 'base') {
        ...
        prepend(css, (0, _updateSource.default)([...normalizeStyles.nodes, ...baseStyles.nodes], atRule.source));
        atRule.remove();
      } else if (atRule.params === 'arrows') {
        const styles = _postcss.default.parse(_fs.default.readFileSync(`${__dirname}/css/arrows.css`, 'utf8'));

        prepend(css, (0, _updateSource.default)([...styles.nodes], atRule.source));
        atRule.remove();
      }
    });
  };
